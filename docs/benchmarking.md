...
Runs all 26 predefined templates once with a single input size, providing a comprehensive performance overview.
...
The benchmark suite includes 26 predefined templates covering:
...
/bench main HEAD
/bench v0.13.0 main
/bench abc123f def456g 100 10000
```
...
**Note:** The CI workflow uses all templates mode for comprehensive regression testing.
